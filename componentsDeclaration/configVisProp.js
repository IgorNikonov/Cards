export const visitorProp = {lastName: "visitor-last-name", mainName: "visitor-name",
    patrName: "visitor-patr-name", purpose: "purpose", description: "description", urgency: "urgency", hadDeseases: "visitor-deseases", bodyWeightIndex: "weight-index", pressure: "visitor-pressure", age: "visitor-age", lastVisitDate: "last-visit-date"};
